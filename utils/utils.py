...
def search_block_by_timestamp(timestamp: int, blockchain: str, rpc_get_block: callable) -> int:
        ...
        block_2000 = rpc_get_block(blockchain, hex(current_block_number - 2000), full_transactions=False)
        ...
        while abs(last_estimated_timestamp - timestamp) > tolerance:
            ...
            last_estimated_block = rpc_get_block(blockchain, hex(last_estimated_number), full_transactions=False)
